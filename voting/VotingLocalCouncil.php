<?php
    ...
    $query = 'select * from tbvoters where stud_id="'.$voter.'" AND campus="'.$campus.'"';
...
<script>
  ...
  $(document).ready(function () {
    ...
    if (campus == "Obrero") {
      ...
      if (program == "BS in Mining Engineering" || program == "BS in Mechanical Engineering" || program ==
        "BS in Electronics Engineering" || program == "BS in Electrical Engineering" || program ==
        "BS in Civil Engineering" || program == "BS in Sanitary Engineering" || program == "BS in Geology" ||
        program == "BS in Geodetic Engineering") {
        $("#img").attr("src", "../img/Obrero_LC_Logo/CE.jpg");
      }
      //College of Business Administration
      else if (program == "BS in Business Administration" || program == "BS in Hospitality Management" || program ==
        "BS in Entrepreneurship" || program == "BS in Accountancy") {
        $("#img").attr("src", "../img/Obrero_LC_Logo/CBA.jpg");
      }
      //College of Education
      else if (program == "BSEd in Mathematics" || program == "BSEd in English" || program == "BSEd in Science" ||
        program == "Bachelor of Elementary Education" || program == "Bachelor of Early Childhood Education" ||
        program == "Bachelor of Special Needs Education" || program == "Bachelor of Physical Education" ||
        program == "Bachelor of Technology and Livelihood Education in Home Economics" || program ==
        "Bachelor of Technical-Vocational Teacher Education") {
        $("#img").attr("src", "../img/Obrero_LC_Logo/COE.jpg");
      }
      //College of Technology
      else if (program == "Diploma of Technology" || program == "Bachelor of Industrial Technology" || program ==
        "Bachelor of Industrial Technology major in Automotive Technology" || program ==
        "Bachelor of Technical Teacher Education major in Construction Technology" || program ==
        "Diploma of Technology major in Mechanical Technology" || program ==
        "Bachelor of Technical Teacher Education" || program == "Bachelor of Science in Computer Technology") {
        $("#img").attr("src", "../img/Obrero_LC_Logo/COT.jpg");
      }
      //College of Information and Computing
      else if (program == "BS in Information Technology" || program == "BS in Computer Science" || program ==
        "Bachelor of Library and Information Science") {
        $("#img").attr("src", "../img/Obrero_LC_Logo/CIC.jpg");
      }
      //College of Applied Economics
      else if (program == "BS in Economics" || program == "BS in Agricultural Economics") {
        $("#img").attr("src", "../img/Obrero_LC_Logo/SAEC.jpg");
        $("#img").removeClass("rounded-circle");
        $("#img").addClass("rounded");
      }
      //College of Arts and Sciences
      else if (program == "AB in Literature and Cultural Studies" || program == "AB in Literature" || program ==
        "BS in Biology" || program == "BS in Statistics" || program == "BS in Mathematics" || program ==
        "AB in English Language") {
        $("#img").attr("src", "../img/Obrero_LC_Logo/CAS.jpg");
      }
    } else if (campus == "Mintal") {
      $("#img").attr("src", "../img/campus_logos/mintal_logo.png");
