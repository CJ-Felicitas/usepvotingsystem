...
"columnDefs": [ {
    "targets": -1,
    "data": null,
    "defaultContent": "<button class='btn btn-warning text-white' data-toggle='modal' data-target='#editUserModal'> <i class='fa fa-pencil-square' aria-hidden='true'></i></button> <button class='btn btn-danger' id='deleteUser' data-toggle='modal' data-target='#deleteUserModal'> <i class='fa fa-trash' aria-hidden='true'></i></button>"
} ]
} );
