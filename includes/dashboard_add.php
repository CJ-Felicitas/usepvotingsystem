...
<?php
  $conn = new mysqli(DB_HOST,DB_USER,DB_PASS,DB_NAME);
  $query  = "select count(distinct studID) from tb_votes group by campus";
...
<?php
  ...
  $conn = new mysqli(DB_HOST,DB_USER,DB_PASS,DB_NAME);
  $query  = "select DISTINCT studID,voter_college,campus from tb_votes ";
  $query2  = "select *  from tbvoters ";
