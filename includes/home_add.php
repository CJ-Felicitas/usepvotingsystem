...
<?php
  ...
  $conn = new mysqli(DB_HOST,DB_USER,DB_PASS,DB_NAME);
  $query  = "select college, COUNT(*)  from tbvoters where campus ='$campus' group by college";
...
<?php
  $campus = $_SESSION['campus'];
  $conn = new mysqli(DB_HOST,DB_USER,DB_PASS,DB_NAME);
  $query  = "select * from tbvoters where campus= '$campus'  ";
...
<?php
  ...
  $query2  = "select * from tbvoters where campus= '$campus'  ";
